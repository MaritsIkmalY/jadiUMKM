<x-main-layout>
    ...
    <div class="relative isolate overflow-hidden bg-white py-16 sm:py-32">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                <h2 class="text-4xl font-bold tracking-tight text-black sm:text-6xl">Tentang Kami</h2>
    ...
    <div class="bg-unyu px-6 py-16 sm:py-16 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Kontak Kami</h2>
        </div>
        <form action="https://formspree.io/f/mgebpkwk" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
            ...
            <div class="mt-10 text-white">
                <button type="submit"
                    class="btn border-none block w-full rounded-md px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    Kirim</button>
            </div>
        </form>
    </div>
